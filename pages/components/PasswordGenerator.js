...
const PasswordGenerator = () => {
    ...
    const [passwordStrength, setPasswordStrength] = useState(''); // Adicionando estado para a força da senha
    ...
    const assessPasswordStrength = (password) => {
        // Lógica simples para avaliar a força da senha
    ...
    return (
        <div className="max-w-lg mx-auto mt-8 p-6 bg-white/10 shadow-lg rounded-lg border-gray-200 shadow-black/50">
            ...
            <div className="mb-4">
                ...
                <div className="flex items-center">
                    <input
                        ...
                        className="mr-2"
                    />
                    <label className="mr-4 text-gray-100">Letras maiúsculas</label>
                    ...
                    <input
                        ...
                        className="mr-2"
                    />
                    <label className="mr-4 text-gray-100">Letras minúsculas</label>
                    ...
                    <input
                        ...
                        className="mr-2"
                    />
                    <label className="mr-4 text-gray-100">Números</label>
                    ...
                    <input
                        ...
                        className="mr-2 "
                    />
                    <label className="text-gray-100">Caracteres especiais</label>
                </div>
            </div>
            ...
            {password && (
                <div className="mt-4 flex items-center flex-auto">
                    <div className="flex-grow">
                        ...
                        />
                        <span
                            className="text-blue-200 font-semibold text-sm bg-slate-800 rounded-md px-2.5 py-1 hover:text-slate-200 hover:bg-slate-950 transition-all cursor-pointer items-center justify-center relative"
